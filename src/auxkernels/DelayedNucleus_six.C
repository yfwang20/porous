#include "DelayedNucleus_six.h"

registerMooseObject("PorousApp", DelayedNucleus_six);

InputParameters DelayedNucleus_six::validParams()
{
...
DelayedNucleus_six::DelayedNucleus_six(const InputParameters & parameters)
...
Real DelayedNucleus_six::computeValue()
{
