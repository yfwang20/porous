#include "Material_Porous_Singlegroup_Solidandcoolant.h"

registerMooseObject("PorousApp", Material_Porous_Singlegroup_Solidandcoolant);

InputParameters Material_Porous_Singlegroup_Solidandcoolant::validParams()
{
...
Material_Porous_Singlegroup_Solidandcoolant::Material_Porous_Singlegroup_Solidandcoolant(const InputParameters & parameters)
    :   Material(parameters),
...
void Material_Porous_Singlegroup_Solidandcoolant::computeQpProperties()
{
