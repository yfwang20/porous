...
class Material_Porous_Singlegroup_Onlysolid : public Material
{
public:
    static InputParameters validParams();

    Material_Porous_Singlegroup_Onlysolid(const InputParameters & parameters);

protected:
    virtual void computeQpProperties() override;

    const VariableValue & _tem_solid;
    const Real & _input_tem_coolant;
    ...
    MaterialProperty<Real> & _tem_coolant;
